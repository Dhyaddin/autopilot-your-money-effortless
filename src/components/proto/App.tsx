...
function Frame() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-black p-2 sm:p-6">
      <div className="relative w-full max-w-[390px] h-[844px] max-h-[100dvh] sm:max-h-[844px] bg-background sm:rounded-[44px] overflow-hidden sm:border-[8px] sm:border-neutral-900 sm:shadow-2xl">
        <Cmp />
        <Overlays />
      </div>
    </div>
